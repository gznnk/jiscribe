import { calcInverseAffineTransformation } from "./calcInverseAffineTransformation";
 ...
 */
export const calcEfficientInverseAffineTransformation = (
	px: number,
	py: number,
	sx: number,
	sy: number,
	...
	return calcInverseAffineTransformation(px, py, sx, sy, theta, tx, ty);
};
