...
/** Preview renderer for a Trapezoid shape while it is being drawn. */
export const TrapezoidPreview: ShapePreviewRenderer = ({
	startX,
	startY,
	endX,
	endY,
	...
	return (
		<polygon
			points={buildTrapezoidPoints(x, y, width, height)}
			style={{ fill, stroke }}
