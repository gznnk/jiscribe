...
/** Preview renderer for a Hexagon shape while it is being drawn. */
export const HexagonPreview: ShapePreviewRenderer = ({
	startX,
	startY,
	endX,
	endY,
	...
	return (
		<polygon
			points={buildHexagonPoints(x, y, width, height)}
			style={{ fill, stroke }}
