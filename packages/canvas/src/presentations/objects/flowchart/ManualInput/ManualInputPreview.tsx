...
/** Preview renderer for a ManualInput shape while it is being drawn. */
export const ManualInputPreview: ShapePreviewRenderer = ({
	startX,
	startY,
	endX,
	endY,
	...
	return (
		<polygon
			points={buildManualInputPoints(x, y, width, height)}
			style={{ fill, stroke }}
