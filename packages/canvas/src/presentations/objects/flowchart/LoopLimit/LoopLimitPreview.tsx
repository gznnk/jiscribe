...
/** Preview renderer for a LoopLimit shape while it is being drawn. */
export const LoopLimitPreview: ShapePreviewRenderer = ({
	startX,
	startY,
	endX,
	endY,
	...
	return (
		<polygon
			points={buildLoopLimitPoints(x, y, width, height)}
			style={{ fill, stroke }}
