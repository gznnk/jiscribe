...
/** Preview renderer for a Parallelogram shape while it is being drawn. */
export const ParallelogramPreview: ShapePreviewRenderer = ({
	startX,
	startY,
	endX,
	endY,
	...
	return (
		<polygon
			points={buildParallelogramPoints(x, y, width, height)}
			style={{ fill, stroke }}
