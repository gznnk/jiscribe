...
/** Preview renderer for an Extract shape while it is being drawn. */
export const ExtractPreview: ShapePreviewRenderer = ({
	startX,
	startY,
	endX,
	endY,
	...
	return (
		<polygon
			points={buildExtractPoints(x, y, width, height)}
			style={{ fill, stroke }}
