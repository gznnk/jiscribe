/** SVG namespace. Passed to DOMPurify / DOMParser. */
export const SVG_NAMESPACE = "http://www.w3.org/2000/svg";

/**
 * Placeholder rendered in place of an SVG when its display or parsing fails.
 * A self-contained 100×100px SVG: a muted-gray dashed border plus a warning icon that fits VSCode.
 */
