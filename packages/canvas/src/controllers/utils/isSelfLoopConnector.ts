 ...
 * lift the degeneracy — a self-loop with any is drawn through them either way (see
 * resolveConnectorPoints) — but there is no way to add one before the shape is chosen, so the
 * menu stays hidden.
 *
