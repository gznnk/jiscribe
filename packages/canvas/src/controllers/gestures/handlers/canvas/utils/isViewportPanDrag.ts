 ...
 * GestureRecognizer as its shouldPinchFromDrag policy: a second touch may close
 * such a drag and convert it into a pinch, while object drags and shape drawing
 * must not be interrupted (#25). Living beside the routing keeps the "what is a
 * pan" knowledge out of the recognizer.
 *
