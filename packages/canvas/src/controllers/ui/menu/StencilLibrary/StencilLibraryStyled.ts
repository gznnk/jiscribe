 ...
 */
export const StencilCategoryContainer = styled.div`
	position: relative;
	display: flex;
`;
...
/**
 * Flyout panel dropped below a category button, containing that category's stencil
 ...
 */
export const StencilCategoryFlyout = styled.div`
	position: absolute;
	top: calc(100% + 4px);
	left: 0;
	z-index: 20;
