...
/**
 * The built-in factories in one registry — the same table `BUILTIN_OBJECT_DEFINITIONS`
 * carries on the canvas side, minus its UI half. Lets the doc-side creation tests run
