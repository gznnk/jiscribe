...
/**
 * Maps TransformDoc to Transform.
 ...
 */
export function mapTransformDocToState(doc: TransformDoc): Transform {
...
/**
 * Maps Transform to TransformDoc.
 ...
 */
export function mapTransformStateToDoc(state: Transform): TransformDoc {
