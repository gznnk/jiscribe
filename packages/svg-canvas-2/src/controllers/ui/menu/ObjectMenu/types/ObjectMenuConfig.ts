/**
 * Configuration for which menu categories to display when an object is selected.
 * Each property indicates whether that menu category should be shown.
 *
 * Based on svg-canvas's DiagramMenuConfig but adapted for svg-canvas-2 architecture.
 */
export type ObjectMenuConfig = {
	/** Show background/fill color picker */
	backgroundColor?: boolean;

	/** Show border color picker */
	borderColor?: boolean;

	/** Show line color picker (for lines, connectors) */
	lineColor?: boolean;
