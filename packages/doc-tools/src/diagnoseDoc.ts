 ...
 *
 * Only overflow is reported. Spacing, aspect ratio and the other matters of
 * style are deliberately left out: this answers "would a reader see the text cut
 * off", which is a fact about the document rather than a matter of taste.
 *
