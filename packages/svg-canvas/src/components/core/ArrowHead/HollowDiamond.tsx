...
/**
 * HollowDiamond arrow head component.
 */
const HollowDiamondArrowHeadComponent: React.FC<ArrowHeadComponentProps> = ({
	x,
	y,
	color,
	radians,
...
export const HollowDiamondArrowHead = memo(HollowDiamondArrowHeadComponent);
