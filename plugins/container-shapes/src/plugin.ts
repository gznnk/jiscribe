...
/**
 * `CanvasPlugin` declaration for the container shapes (docs/05_extensibility/
 * canvas-plugin-design.md). Hosts wire this into both `createCanvasParser` and
 * `<Canvas initialConfig>` via a single `plugins` array.
 */
