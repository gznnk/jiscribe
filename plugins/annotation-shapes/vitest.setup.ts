...
// throws (see @jiscribe/canvas-sdk/doc). A group marker's label box is sized from
// its own text, so these tests measure; without a browser they run on the
// estimate, stated here rather than left to a fallback.
