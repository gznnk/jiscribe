...
_(Our public JSON schema that powers this will be available at: `https://schema.jiscribe.dev/canvas-doc.schema.json`)_
...
`https://schema.jiscribe.dev/canvas-doc.schema.json` _(Placeholder)_

### Top-level Structure

```json
{
	"$schema": "https://schema.jiscribe.dev/canvas-doc.schema.json",
	"root": [],
	"connectors": []
}
```
