// flowchart / container / markdown 図形は @workspace/plugin-flowchart-shapes /
// @workspace/plugin-container-shapes / @workspace/plugin-markdown-shape から供給する
...
export const plugins = [flowchartPlugin, containerPlugin, markdownPlugin];
